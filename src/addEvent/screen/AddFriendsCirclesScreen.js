...
const AddFriendsCircles = ({ navigation, route }) => {
  ...
  /* events get created
  1. creating a document in the [Events] collection
  2. updating user profile with the 'myEvents' field 
  3. updating friends/circles who were added to the events, 'otherEvents'
  */
